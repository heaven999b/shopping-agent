...
def _profile_to_dict(p: UserProfile) -> dict:
    return {
        ...
        "identity_goal": p.identity_goal,
        "budget_sensitivity_profile": p.budget_sensitivity_profile,
        "brand_orientation": p.brand_orientation,
        "aesthetic_preference": p.aesthetic_preference,
        "persona_stability": p.persona_stability,
        "recent_persona_drift": p.recent_persona_drift,
        "persona_transition_log": p.persona_transition_log,
        "owned_items": p.owned_items,
        "active_setups": p.active_setups,
        "upgrade_stage": p.upgrade_stage,
        "purchase_rhythm": p.purchase_rhythm,
        "aspiration_signals": p.aspiration_signals,
...
def _dict_to_profile(d: dict) -> UserProfile:
    return UserProfile(
        ...
        identity_goal=d.get("identity_goal", {}),
        budget_sensitivity_profile=d.get("budget_sensitivity_profile", {}),
        brand_orientation=d.get("brand_orientation", {}),
        aesthetic_preference=d.get("aesthetic_preference", {}),
        persona_stability=d.get("persona_stability", 0.5),
        recent_persona_drift=d.get("recent_persona_drift", {}),
        persona_transition_log=d.get("persona_transition_log", []),
        owned_items=d.get("owned_items", []),
        active_setups=d.get("active_setups", {}),
        upgrade_stage=d.get("upgrade_stage", {}),
        purchase_rhythm=d.get("purchase_rhythm", {}),
        aspiration_signals=d.get("aspiration_signals", []),
